...
const Home = () => {
  ...
  return (
    ...
    <Wrapper>
      ...
      <div id='font1' style={{padding: '2rem', backgroundColor: 'rgba(32, 32, 32, 0.6)', width: '560px', paddingLeft: '30px', position: 'relative', left: '110px', textShadow: '2px 2px 5px rgba(0,0,0,0.25)'}}>
        <p style={{fontSize: 36, color: '#FDDDFD', textShadow: '2px 2px 5px rgba(0,0,0,0.25)'}}>Skim & Ride</p>
